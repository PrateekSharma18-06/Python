...
plot20.getAxis('right').linkToView(vb_right_20)
vb_right_20.setXLink(plot20)
...
def updateViews_20():
    ...
    vb_right_20.linkedViewChanged(plot20.vb, vb_right_20.XAxis)

def adjust_right_view_20():
    """Dynamically adjust the range of the right Y-axis for plot20."""
    if y13_1:
        vb_right_20.setRange(yRange=(min(y13_1), max(y13_1)), padding=0.1)
...
def updateViews_21():
    ...
    vb_right_21.linkedViewChanged(plot21.vb, vb_right_21.XAxis)

def adjust_right_view_21():
    """Dynamically adjust the range of the right Y-axis for plot21."""
    if y13_2:
        vb_right_21.setRange(yRange=(min(y13_2), max(y13_2)), padding=0.1)
...
def updateViews_22():
    ...
    vb_right_22.linkedViewChanged(plot22.vb, vb_right_22.XAxis)

def adjust_right_view_22():
    """Dynamically adjust the range of the right Y-axis for plot22."""
    if y13_3:
        vb_right_22.setRange(yRange=(min(y13_3), max(y13_3)), padding=0.1)
